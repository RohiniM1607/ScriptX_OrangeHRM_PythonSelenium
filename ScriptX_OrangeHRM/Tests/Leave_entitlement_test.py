...
class TestLeaveEntitlement:
    ...
    @pytest.mark.myl
    @pytest.mark.parametrize("LeaveType, Entitlement", Excel_Reader.invalid_AddLeave_data("ScriptX_OrangeHRM/Configurations/TestData.xlsx", "All Leave"))
    ...
    @pytest.mark.myl
    @pytest.mark.parametrize("EmployeeName, LeaveType, Entitlement", Excel_Reader.exceed_LeaveLimit("ScriptX_OrangeHRM/Configurations/TestData.xlsx", "All Leave"))
